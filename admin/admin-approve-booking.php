  ...
  if(isset($_POST['approve_booking']))
    {
           ...
           //$u_boat_regno  = $_POST['u_boat_regno'];
            ...
            $query="update tms_user set  u_boat_book_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('si',  $u_boat_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
     ...
     <div id="wrapper">
        ...
        -->
            ...
            <div class=" form-group">
                                 ...
                                 <input type="email" readonly value="<?php echo $row->u_boat_type;?>" class="form-control" name="u_boat_type">
                             </div>
                                 
                             <div class="form-group">
                                 <label for="exampleInputEmail1">Vehicle Registration NUmber</label>
                                 <input type="email" readonly value="<?php echo $row->u_boat_regno;?>" class="form-control" name="u_boat_category">
                             </div>


                             <div class="form-group">
                                 <label for="exampleInputEmail1">Booking Date</label>
                                 <input type="text" readonly value="<?php echo $row->u_boat_bookdate;?>" class="form-control" id="exampleInputEmail1" name="u_boat_bookdate">
                             </div>

                             <div class="form-group">
                                 <label for="exampleFormControlSelect1">Booking Status</label>
                                 <select class="form-control" name="u_boat_book_status" id="exampleFormControlSelect1">
