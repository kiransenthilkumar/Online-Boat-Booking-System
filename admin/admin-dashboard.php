        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                ?>
                  ...
                  $result ="SELECT count(*) FROM tms_user where u_boat_book_status = 'Approved' || u_boat_book_status = 'Pending' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
                ...
                <div class="card mb-3">
                  ...
                  $ret="SELECT * FROM tms_user where u_boat_book_status = 'Approved' || u_boat_book_status = 'Pending' "; //get all bookings
                ...
                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row->u_boat_type;?></td>
                                        <td><?php echo $row->u_boat_regno;?></td>
                                        <td><?php echo $row->u_boat_bookdate;?></td>
                                        <td><?php if($row->u_boat_book_status == "Pending"){ echo '<span class = "badge badge-warning">'.$row->u_boat_book_status.'</span>'; } else { echo '<span class = "badge badge-success">'.$row->u_boat_book_status.'</span>';}?></td>
